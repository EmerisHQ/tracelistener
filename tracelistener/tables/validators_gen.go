...
func (r ValidatorsTable) CreateTable() string {
	return fmt.Sprintf(`
		...
		(id serial PRIMARY KEY, height integer NOT NULL, delete_height integer, chain_name text NOT NULL, operator_address text NOT NULL, consensus_pubkey_type text, consensus_pubkey_value bytes, jailed bool NOT NULL, status integer NOT NULL, tokens text NOT NULL, delegator_shares text NOT NULL, moniker text, identity text, website text, security_contact text, details text, unbonding_height bigint, unbonding_time text, commission_rate text NOT NULL, max_rate text NOT NULL, max_change_rate text NOT NULL, update_time text NOT NULL, min_self_delegation text NOT NULL, UNIQUE (chain_name, operator_address))
	`, r.tableName)
}

func (r ValidatorsTable) Insert() string {
	return fmt.Sprintf(`
		INSERT INTO %s (height, chain_name, operator_address, consensus_pubkey_type, consensus_pubkey_value, jailed, status, tokens, delegator_shares, moniker, identity, website, security_contact, details, unbonding_height, unbonding_time, commission_rate, max_rate, max_change_rate, update_time, min_self_delegation)
		VALUES (:height, :chain_name, :operator_address, :consensus_pubkey_type, :consensus_pubkey_value, :jailed, :status, :tokens, :delegator_shares, :moniker, :identity, :website, :security_contact, :details, :unbonding_height, :unbonding_time, :commission_rate, :max_rate, :max_change_rate, :update_time, :min_self_delegation)
	`, r.tableName)
}
